...
const GraphContainer = styled.div`
  ...
  width:600px;
`
const PerformanceDetailsChart = ({employeeData}) => {
    const chartData = {
  ...
  return (
    <GraphContainer>
      <div style={{alignItems:'center', justifyContent:'center',textAlign:'center'}}>
          ...
          <span style={{fontSize:"30px"}}>Number of tasks you have assisted or completed.</span>
      </div>
    </GraphContainer>
  )
}

export default PerformanceDetailsChart